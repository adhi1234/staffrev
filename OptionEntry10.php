...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(9,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";
...
<form method="POST" action="OptionEntry11.php">
  ...
  <table border="0" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="44%" id="AutoNumber2" height="37">
    <tr bgcolor="#FFFFFF">
      <td width="100%" height="37" class="style10"> <span style="margin-top: 0; margin-bottom: 0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Question&nbsp;<span class="style17">10</span></span> : Behavior&nbsp; of&nbsp;&nbsp;
      the&nbsp; teacher </td>
    </tr>
  </table>
  ...
  <div align="center">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="44%" height="93" style="border-collapse: collapse">
    <tr>
      <td height="24" colspan="3" align="justify" class="style10">
        <p align="left" style="margin-top: 0; margin-bottom: 0">Options</td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td width="30%" height="1" align="justify" class="style10">
        <p align="left" style="margin-top: 0; margin-bottom: 0">1. &nbsp;Pleasant&nbsp; </td>
      <td width="32%" align="justify" class="style10"><span style="margin-top: 0; margin-bottom: 0">2. &nbsp;Indifferent</span></td>
      <td width="38%" align="justify" class="style10">3. &nbsp;Unpleasant</td>
    </tr>
    <tr>
      <td height="1" colspan="3" align="justify" class="style10"><p>&nbsp;</p>
        <p>&nbsp;</p></td>
    </tr>
    <tr>
      <td height="1" colspan="3" align="justify" class="style10">      </td>
    </tr>
    </table>
    </center>
  </div>
