...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(12,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";





//$sqlquery="insert into response values(12,'".$_POST[T2]."','".$_POST[T3]."','".$_POST[T4]."','".$_POST[T5]."','".$_POST[T6]."','".$_POST[T7]."','".$_POST[T8]."','".$_POST[T9]."','".$_POST[T11]."','".$_POST[T10]."')";

//$sqlquery="insert into response values(12,'".$T2."','".$T3."','".$T4."','".$T5."','".$T6."','".$T7."','".$T8."','".$T9."','".$T11."','".$T10."')";
...
<form method="POST" action="OptionEntry14.php">
  ...
  <table border="1" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="66%" id="AutoNumber2" height="37">
    <tr bgcolor="#FFFFFF">
      <td width="100%" height="37" class="style17"><b><span style="margin-top: 0; margin-bottom: 0"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Question</b> <b>&nbsp;<span class="style19">13</span> : </b></span>Teacher introduces&nbsp;
      current / emerging topics&nbsp; in the lecture</b></td>
    </tr>
  </table>
  <p class="style17" style="margin-top: 0; margin-bottom: 0"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></p>
  <div align="center" class="style17">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="66%" height="93" style="border-collapse: collapse">
    <tr>
      <td height="24" colspan="3" align="justify">
        <p align="left" style="margin-top: 0; margin-bottom: 0"><span class="style17" style="margin-top: 0; margin-bottom: 0"><b>&nbsp;
  Options</b></span></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td width="38%" height="1" align="justify">
        <p align="center" style="margin-top: 0; margin-bottom: 0"><strong>1. &nbsp;Frequently</strong></td>
      <td width="31%" align="justify"><div align="center"><span style="margin-top: 0; margin-bottom: 0"><strong>2. &nbsp;Sometimes</strong></span></div></td>
      <td width="31%" align="justify"><div align="center"><strong>3. &nbsp;Never</strong></div></td>
    </tr>
    <tr>
      <td height="1" colspan="3" align="justify">&nbsp;</td>
    </tr>
    <tr>
      <td height="1" colspan="3" align="justify">      </td>
    </tr>
  ...
  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="91%" id="AutoNumber3" align="center" height="16">
    <tr>
      <td width="10%" height="19" align="center" class="style10">T1</td>
      <td width="10%" height="19" align="center" class="style10">T2</td>
      <td width="10%" height="19" align="center" class="style10">T3</td>
      <td width="10%" height="19" align="center" class="style10">T4</td>
      <td width="10%" height="19" align="center" class="style10">T5</td>
      <td width="10%" height="19" align="center" class="style10">T6</td>
      <td width="10%" height="19" align="center" class="style10">T7</td>
      <td width="10%" height="19" align="center" class="style10">T8</td>
      <td width="10%" height="19" align="center" class="style10">T9</td>
      <td width="10%" height="19" align="center" class="style10">T10</td>
    </tr>
    <tr>
      <td width="10%" height="1" class="style17">
      <p align="center">
