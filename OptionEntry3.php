...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(2,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";
...
<form method="POST" action="OptionEntry4.php">
  ...
  <table border="0" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="54%" id="AutoNumber2" height="37">
    <tr>
      <td width="19%" height="37" bgcolor="#FFFFFF"><span class="style10">&nbsp;<b>Question</b> : <span class="style17">3</span></span></td>
      <td width="81%" bgcolor="#FFFFFF"><span class="style10">Clarity
      and Understandability of Teacher's explanation</span></td>
    </tr>
  </table>
  <p style="margin-top: 0; margin-bottom: 0"><font face="Georgia"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></p>
  <div align="center">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="55%" height="167" style="border-collapse: collapse">
    <tr>
      <td height="43" colspan="4" align="justify">
        <p align="left" class="style10" style="margin-top: 0; margin-bottom: 0">Options</td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td width="26%" height="32" align="justify">
        <p align="center" class="style10" style="margin-top: 0; margin-bottom: 0">1. Excellent</td>
      <td width="23%" align="justify"><div align="center"><span class="style10" style="margin-top: 0; margin-bottom: 0">2. Good</span></div></td>
      <td width="28%" align="justify"><div align="center"><span class="style10">3. Fair</span></div></td>
      <td width="23%" align="justify"><div align="center"><span class="style10">4. Poor</span></div></td>
    </tr>
    <tr>
      <td height="46" colspan="4" align="justify">&nbsp;</td>
    </tr>
    <tr>
      <td height="46" colspan="4" align="justify">&nbsp;</td>
    </tr>
