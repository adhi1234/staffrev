...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(11,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";





//$sqlquery="insert into response values(11,'".$_POST[T2]."','".$_POST[T3]."','".$_POST[T4]."','".$_POST[T5]."','".$_POST[T6]."','".$_POST[T7]."','".$_POST[T8]."','".$_POST[T9]."','".$_POST[T11]."','".$_POST[T10]."')";

//$sqlquery="insert into response values(11,'".$T2."','".$T3."','".$T4."','".$T5."','".$T6."','".$T7."','".$T8."','".$T9."','".$T11."','".$T10."')";
...
<title>Instruction to the Students</title>
...
<form method="POST" action="OptionEntry13.php">
  ...
  <table border="1" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="52%" id="AutoNumber2" height="37">
    <tr bgcolor="#FFFFFF">
      <td width="100%" height="37" class="style18"><b><span style="margin-top: 0; margin-bottom: 0"><b>Question&nbsp;<span class="style17">12</span></b></span> : Whether&nbsp; all the
      topics in the syllabus&nbsp; are&nbsp; taught?</b></td>
    </tr>
  </table>
  <p class="style18" style="margin-top: 0; margin-bottom: 0"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></p>
  <div align="center" class="style18">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="51%" height="93" style="border-collapse: collapse">
    <tr>
    ...
    <tr>
      <td width="28%" height="1" align="justify" bgcolor="#FFFFFF">
        <p align="center" style="margin-top: 0; margin-bottom: 0"><strong>1. &nbsp;100%</strong></td>
      <td width="34%" align="justify" bgcolor="#FFFFFF"><div align="center"><span style="margin-top: 0; margin-bottom: 0"><strong> 2. &nbsp;Above
        75%</strong></span></div></td>
      <td width="38%" align="justify" bgcolor="#FFFFFF"><div align="center"><strong>3. &nbsp;Below
        75%</strong></div></td>
    </tr>
    <tr>
