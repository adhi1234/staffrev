...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(4,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";



//$sqlquery="insert into response values(2,'".$_POST[T2]."','".$_POST[T3]."','".$_POST[T4]."','".$_POST[T5]."','".$_POST[T6]."','".$_POST[T7]."','".$_POST[T8]."','".$_POST[T9]."','".$_POST[T11]."','".$_POST[T10]."')";

//$sqlquery="insert into response values(2,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T11','$T10')";
...
<form method="POST" action="OptionEntry6.php">
  ...
  <p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
  <table border="1" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="69%" id="AutoNumber2" height="37">
    <tr bgcolor="#FFFFFF">
      <td width="100%" height="37" class="style18"><b>&nbsp;<span style="margin-top: 0; margin-bottom: 0"><b>Question</b> <span class="style17">5</span></span></b> <b>: Whether
      the teacher ONLY dictates&nbsp; notes without adequate explanation</b></td>
    </tr>
  </table>
  <p class="style18" style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
  <div align="center" class="style18">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="31%" height="93" style="border-collapse: collapse">
    <tr>
      <td height="24" colspan="2" align="justify">
    ...
    <tr bgcolor="#FFFFFF">
      <td width="32%" height="1" align="justify">
        <p align="center" style="margin-top: 0; margin-bottom: 0"><strong>1. Yes</strong></td>
      <td width="68%" align="justify"><div align="center"><strong><span style="margin-top: 0; margin-bottom: 0">2. No</span></strong></div></td>
    </tr>
    </table>
    <p>&nbsp;</p>
    </center>
