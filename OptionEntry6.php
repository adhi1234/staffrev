...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(5,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";
...
<form method="POST" action="OptionEntry7.php">
  ...
  <table border="1" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="59%" id="AutoNumber2" height="37">
    <tr bgcolor="#FFFFFF">
      <td width="100%" height="37" class="style18"><strong> <b>&nbsp;&nbsp;&nbsp;&nbsp; Question</b><span class="style17"> 6</span> &nbsp;: Does the teacher
      review notes prepared by the students?</strong></td>
    </tr>
  </table>
  <p class="style18" style="margin-top: 0; margin-bottom: 0"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></p>
  <div align="center">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="59%" height="93" style="border-collapse: collapse">
    <tr>
      <td height="24" colspan="3" align="justify" class="style18">
        <p align="left" style="margin-top: 0; margin-bottom: 0"><b>Options</b></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td width="38%" height="1" align="justify" class="style18">
        <p align="center" style="margin-top: 0; margin-bottom: 0"><strong>1. Frequently</strong></td>
      <td width="34%" align="justify" class="style18"><div align="center"><span style="margin-top: 0; margin-bottom: 0"><strong>2. Sometimes</strong></span></div></td>
      <td width="28%" align="justify" class="style18"><div align="center"><strong>3. Never</strong></div></td>
    </tr>
    <tr>
      <td height="1" colspan="3" align="justify" class="style18">&nbsp;</td>
    </tr>
    <tr>
      <td height="1" colspan="3" align="justify" class="style18">      </td>
    </tr>
