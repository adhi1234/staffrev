...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
echo $sqlquery="insert into response values(1,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";
$queryresult=mysql_query($sqlquery)  or die("Could not execute query");
 ?>
<html>
...
<form method="POST" action="OptionEntry3.php">
 <!-- webbot bot="SaveResults" u-file="D:\Evaluation\_private\form_results.csv" s-format="TEXT/CSV" s-label-fields="TRUE" -->
  ...
  <table border="0" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="56%" id="AutoNumber2" height="37">
    <tr>
      <td width="27%" height="37" bgcolor="#FFFFFF"><font face="Georgia"><b>&nbsp; <span style="margin-top: 0; margin-bottom: 0"><b><font face="Georgia">Question</font></b> <font face="Georgia" class="style14"><b>2</b></font></span> : </b></font></td>
      <td width="73%" bgcolor="#FFFFFF"><font face="Georgia"><b>Use of Black
      Board</b></font></td>
    </tr>
  </table>
  ...
  <div align="center">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="55%" height="165" style="border-collapse: collapse">
    <tr>
    ...
    <tr bgcolor="#FFFFFF" class="style16">
      <td width="26%" height="49" align="justify">
        <p align="center" class="style17" style="margin-top: 0; margin-bottom: 0">1. <b>Effective</b></td>
      <td width="38%" align="justify"><div align="center"><span class="style17" style="margin-top: 0; margin-bottom: 0">2. <b>Not Effective</b></span></div></td>
      <td width="36%" align="justify"><div align="center"><span class="style17">3. <b>Rarely Uses</b></span></div></td>
    </tr>
    <tr>
