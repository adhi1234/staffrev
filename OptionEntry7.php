...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(6,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";
...
<form method="POST" action="OptionEntry8.php">
  ...
  <table border="0" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="70%" id="AutoNumber2" height="37">
    <tr bgcolor="#FFFFFF">
      <td width="21%" height="37"><p class="style18" style="margin-top: 0; margin-bottom: 0"><b>&nbsp; Question</b> : <span class="style17">7</span></p>
      <p class="style18" style="margin-top: 0; margin-bottom: 0"></p></td>
      <td width="79%"><span class="style18"><b>Approximate
      percentage of classes NOT engaged by the teacher.</b></span></td>
    </tr>
  </table>
  <p style="margin-top: 0; margin-bottom: 0"><font face="Georgia"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></p>
  <div align="center">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="70%" height="93" style="border-collapse: collapse">
    <tr>
    ...
    <tr>
      <td width="29%" height="1" align="justify" bgcolor="#FFFFFF">
        <p align="center" class="style10" style="margin-top: 0; margin-bottom: 0">1. Less than 10%</td>
      <td width="33%" align="justify" bgcolor="#FFFFFF"><div align="center"><span class="style10">2. 10%&nbsp; to&nbsp; 25%</span></div></td>
      <td width="38%" align="justify" bgcolor="#FFFFFF"><div align="center"><span class="style10">3. More than&nbsp;
        25%</span></div></td>
    </tr>
    <tr>
