...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(7,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";
...
<form method="POST" action="OptionEntry9.php">
  ...
  <table border="0" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="75%" id="AutoNumber2" height="37">
    <tr>
      <td width="100%" height="37" bgcolor="#FFFFFF"><span class="style10"> <b>&nbsp;&nbsp;
  Question</b><span class="style20"> 8</span>: Regularity in valuing&nbsp;
      tests and assignments</span></td>
    </tr>
  </table>
  <p style="margin-top: 0; margin-bottom: 0"><font face="Georgia"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></p>
  <div align="center">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="75%" height="93" style="border-collapse: collapse">
    <tr>
    ...
    <tr bgcolor="#FFFFFF">
      <td width="26%" height="1" align="justify">
        <p align="center" class="style10" style="margin-top: 0; margin-bottom: 0">1. Quite punctual</td>
      <td width="25%" align="justify"><div align="center"><span class="style10" style="margin-top: 0; margin-bottom: 0">2. &nbsp;Not Punctual</span></div></td>
      <td width="49%" align="justify"><div align="center"><span class="style10">3. &nbsp;Doesn't&nbsp;
        return the valued scripts at all</span></div></td>
    </tr>
    <tr>
