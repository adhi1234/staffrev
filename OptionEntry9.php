...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(8,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";
...
//$sqlquery="insert into response values(8,'".$_POST[T2]."','".$_POST[T3]."','".$_POST[T4]."','".$_POST[T5]."','".$_POST[T6]."','".$_POST[T7]."','".$_POST[T8]."','".$_POST[T9]."','".$_POST[T11]."','".$_POST[T10]."')";

//$sqlquery="insert into response values(8,'".$T2."','".$T3."','".$T4."','".$T5."','".$T6."','".$T7."','".$T8."','".$T9."','".$T11."','".$T10."')";
...
<form method="POST" action="OptionEntry10.php">
  ...
  <table border="0" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="73%" id="AutoNumber2" height="37">
    <tr bgcolor="#FFFFFF">
      <td width="100%" height="37">
        <p class="style10" style="margin-top: 0; margin-bottom: 0"> Question <span class="style17">9</span>: Whether revision
      classes and review test papers&nbsp; are conducted by the teacher?</p>      </td>
    </tr>
  </table>
  <p style="margin-top: 0; margin-bottom: 0"><font face="Georgia"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></p>
  <div align="center">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="30%" height="95" style="border-collapse: collapse">
    <tr>
      <td height="24" colspan="2" align="justify">
        <p align="left" style="margin-top: 0; margin-bottom: 0"><font face="Georgia"><b>&nbsp;&nbsp;&nbsp; </b></font><b><span class="style18">Options</span></b></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td width="50%" height="2" align="justify">
        <p align="center" class="style10" style="margin-top: 0; margin-bottom: 0">1. Yes</td>
      <td width="50%" align="justify"><div align="center"><span class="style10" style="margin-top: 0; margin-bottom: 0">2. No</span></div></td>
    </tr>
    <tr>
      <td height="21" colspan="2" align="justify">      </td>
    </tr>
    </table>
    <p>&nbsp;</p>
    </center>
