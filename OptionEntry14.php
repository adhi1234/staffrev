...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(13,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";
...
//$sqlquery="insert into response values(13,'".$_POST[T2]."','".$_POST[T3]."','".$_POST[T4]."','".$_POST[T5]."','".$_POST[T6]."','".$_POST[T7]."','".$_POST[T8]."','".$_POST[T9]."','".$_POST[T11]."','".$_POST[T10]."')";

//$sqlquery="insert into response values(13,'".$T2."','".$T3."','".$T4."','".$T5."','".$T6."','".$T7."','".$T8."','".$T9."','".$T11."','".$T10."')";
...
<form method="POST" action="OptionEntry15.php">
  ...
  <table border="0" cellpadding="0" align= center cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="55%" id="AutoNumber2" height="37">
    <tr bgcolor="#FFFFFF">
      <td width="100%" height="37" class="style18"><div align="center"><b> <span style="margin-top: 0; margin-bottom: 0"><b>Question</b> <span class="style17">&nbsp;14</span></span> : Knowledge of teacher
      in the subject</b></div></td>
    </tr>
  </table>
  <p class="style18" style="margin-top: 0; margin-bottom: 0"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></p>
  <div align="center" class="style18">
    <center>
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="55%" height="98" style="border-collapse: collapse">
    <tr>
      <td height="24" colspan="4" align="justify">
        <p align="left" style="margin-top: 0; margin-bottom: 0"></td>
    </tr>
    <tr>
      <td height="27" colspan="4" align="justify">
        <p align="left" style="margin-top: 0; margin-bottom: 0"><span class="style18" style="margin-top: 0; margin-bottom: 0"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Options</b></span></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td width="22%" height="1" align="justify"><div align="center"><span style="margin-top: 0; margin-bottom: 0"><strong>1. &nbsp;Excellent</strong></span></div></td>
      <td width="19%" align="justify"><div align="center"><span style="margin-top: 0; margin-bottom: 0"><strong>2. &nbsp;Good</strong></span></div></td>
      <td width="25%" align="justify"><div align="center"><strong>3. &nbsp;Fair</strong></div></td>
      <td width="34%" align="justify"><div align="center"><strong>4. &nbsp;Poor</strong></div></td>
    </tr>
    <tr>
