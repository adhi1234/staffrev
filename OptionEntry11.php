...
$T10=$_POST['T10'];
$T11=$_POST['T11'];
$sqlquery="insert into response values(10,'$T2','$T3','$T4','$T5','$T6','$T7','$T8','$T9','$T10','$T11')";
...
//$sqlquery="insert into response values(10,'".$_POST[T2]."','".$_POST[T3]."','".$_POST[T4]."','".$_POST[T5]."','".$_POST[T6]."','".$_POST[T7]."','".$_POST[T8]."','".$_POST[T9]."','".$_POST[T11]."','".$_POST[T10]."')";

//$sqlquery="insert into response values(10,'".$T2."','".$T3."','".$T4."','".$T5."','".$T6."','".$T7."','".$T8."','".$T9."','".$T11."','".$T10."')";
...
<form method="POST" action="OptionEntry12.php">
  ...
  <table width="55%" height="37" border="0" align= center cellpadding="0" cellspacing="0" bordercolor="#111111" bgcolor="#FFFFFF" id="AutoNumber2" style="border-collapse: collapse">
    <tr>
      <td width="100%" height="37" class="style18"><b> <span style="margin-top: 0; margin-bottom: 0"><b>&nbsp;&nbsp;
  Question&nbsp;<span class="style17">1</span></b><span class="style17"><b>1</b></span></span> : Teacher's willingness
      to help</b></td>
    </tr>
  </table>
  ...
  <table border="0" cellpadding="0" cellspacing="0"  bordercolor="#111111" width="55%" height="93" style="border-collapse: collapse">
    ...
    <tr bgcolor="#FFFFFF">
      <td width="24%" height="1" align="justify"><div align="center"><strong><span style="margin-top: 0; margin-bottom: 0">1. &nbsp;Excellent</span></strong></div></td>
      <td width="20%" align="justify"><div align="center"><strong><span style="margin-top: 0; margin-bottom: 0">2. &nbsp;Good</span></strong></div></td>
      <td width="22%" align="justify"><div align="center"><strong>3. &nbsp;Fair</strong></div></td>
